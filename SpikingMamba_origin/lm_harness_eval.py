...
class Mamba2EvalWrapper(HFLM):
    ...
    def __init__(self, pretrained, max_length=2048, batch_size=None, device="cuda",
        ...
        LM.__init__(self)
        from smamba_mixer_seq.models.mixer_seq_simple_smamba import MambaLMHeadModel 
        self._model = MambaLMHeadModel.from_pretrained(pretrained, torch_dtype=dtype).model
