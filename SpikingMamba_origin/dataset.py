...
class TextDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {"input_ids": input_ids, "": self.training_label[idx], "attention_mask": input_ids.ne(self.pad_token_id)}
...
if __name__ == "__main__":
    ...
    training_label = torch.load(f'ultrachat_.pt', map_location="cpu")
